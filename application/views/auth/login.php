...
<html>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-CPJVDNCNJ2"></script>
    <script>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body" style="border-radius: 20px;">
                <p class="text-center"><img  style="border-radius: 20px;" src="<?php echo base_url()?>/assets/img/gsk_square.jpg" width="100%"></p>
                <?php
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <button  style="border-radius: 10px;" type="submit" class="btn btn-danger btn-block btn-flat"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</button>
                    </div>
                    <!-- <div class="col-xs-6">
