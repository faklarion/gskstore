...
<body style="background-color: #ffffff;">
    ...
    <div class="container">
        <form action="<?php echo site_url('tukar_tambah/tt_action') ?>" method="get" enctype="multipart/form-data" id="ttbaru" autocomplete="off">
                <div class="row">
                    <div class="col-6 p-1">
    ...
    <div class="container">
        <form action="<?php echo site_url('tukar_tambah/tt_action_second') ?>" method="get" enctype="multipart/form-data" id="ttsecond" autocomplete="off">
                <div class="row">
                    <div class="col-6 p-1">
                        <div class="card mb-2" style="display: flex; flex-direction: column; height: 100%; min-height: 300px;">
                            <div style="flex-grow: 1;">
