        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>index.php/welcome" class="logo">
                    ...
                    <span class="logo-mini"><b>GSK</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>GSK</b> STORE</span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; <?php echo date('Y')?> Galeri Second Kalimantan</a>.</strong> All rights
                reserved.
            </footer>
